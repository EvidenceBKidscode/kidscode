...
s32 GUIScrollBar::getBaseStep() const // :PATCH:
{
	return BaseStep;
}
...
void GUIScrollBar::setBaseStep(s32 step) // :PATCH:
{
	if (step > 0)
		BaseStep = step;
	else
...
//! returns a color
video::SColor GUIScrollBar::getColor(EGUI_DEFAULT_COLOR color) const
{
...
//! sets a color
void GUIScrollBar::setColor(EGUI_DEFAULT_COLOR which, video::SColor newColor, f32 shading)
{
...
void GUIScrollBar::serializeAttributes(io::IAttributes* out, io::SAttributeReadWriteOptions* options=0) const
{
...
void GUIScrollBar::deserializeAttributes(io::IAttributes* in, io::SAttributeReadWriteOptions* options=0)
{
