...
namespace gui
{
	...
	public:
		...
		//! constructor
		GUIButton(IGUIEnvironment* environment, IGUIElement* parent,
		...
		*/
		...
		static GUIButton* addButton(IGUIEnvironment *environment, const core::rect<s32>& rectangle,
			IGUIElement* parent=0, s32 id=-1, const wchar_t* text=0, const wchar_t* tooltiptext = 0);
