...
//	settings->setDefault("screenshot_path", "."); // KIDSCODE - Specific screenshot dir
	...
	settings->setDefault("keymap_drop", ""); // KIDSCODE Changed
...
// << KIDSCODE
	...
	settings->setDefault("gui_scaling", "0.8"); // KIDSCODE Changed (wad 1.0)
	...
	settings->setDefault("item_rtt_speedup_resolution", "0");
...
// << KIDSCODE - Connection to GAR and Edutheque via IGN REST API
	...
	settings->setDefault("secure.http_mods", "ign_utils,kidsbot,player_menu,utilities"); // KIDSCODE Changed
