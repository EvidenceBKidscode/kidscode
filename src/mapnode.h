...
struct MapNode
{
	...
	*/
	...
	/**
	 * This function differs from getLight(enum LightBank bank, const NodeDefManager *nodemgr)
	...
	*/
	void getNodeBoxes(const NodeDefManager *nodemgr, std::vector<aabb3f> *boxes, u8 neighbors = 0);

	/*
		Gets list of selection boxes
	*/
	void getSelectionBoxes(const NodeDefManager *nodemg, std::vector<aabb3f> *boxes, u8 neighbors = 0);

	/*
		Gets list of collision boxes
	*/
	void getCollisionBoxes(const NodeDefManager *nodemgr, std::vector<aabb3f> *boxes, u8 neighbors = 0);
