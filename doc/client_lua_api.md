...
* `minetest.get_player_modes()`
    * Returns a list of current player free_move, fast_move and noclip modes as boolean values indexed by mode name.
* `minetest.set_player_modes(modes)`
    * Sets current player modes. `modes` is a table of boolean indexed by mode name.
